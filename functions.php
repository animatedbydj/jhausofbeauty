...
/**
 * wptailwind functions and definitions
 *
...
if (!function_exists('wptailwind_setup')) :
	...
	function wptailwind_setup()
	{
		 ...
		 * If you're building a theme based on wptailwind, use a find and replace
		...
		register_nav_menus(array(
			'menu-1' => esc_html__('Primary', 'wptailwind'),
		));
		...
		add_theme_support('custom-background', apply_filters('wptailwind_custom_background_args', array(
...
function wptailwind_scripts()
{
	...
	wp_enqueue_script('wptailwind-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true);

	wp_enqueue_script('wptailwind-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true);
	wp_enqueue_script('wptailwind-main', get_template_directory_uri() . '/js/main.js', array(), '20151215', true);
